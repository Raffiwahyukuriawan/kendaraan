				...
				<tbody>
					<?php foreach ($kategori as $kategori1): ?>
						<tr>
							...
							<td>
								<img style="width:10%; height:10%;" src="<?php echo base_url('AdminLTE-3.1.0/assets/kategori/' . $kategori1->foto_kategori); ?>" alt="Logo tidak ada">
							</td>
							<td>
								<div>
									<a class="fas fa-edit" style="color: #13d844;" id="back-to-top" class="btn btn-primary back-to-top mb-5" role="button" data-bs-toggle="modal"
										data-bs-toggle="modal" data-bs-target="#staticBackdrop1<?= $kategori1->id_kategori ?>"
										aria-label="Scroll to top">
									</a>
									<a class=" fas fa-trash mt-1" style="color: #f4301a;" onclick="confirmDeleteKategori('<?= $kategori1->foto_kategori ?>');"></a>
									<!-- update kategori -->
									<div>
										<!-- Modal -->
