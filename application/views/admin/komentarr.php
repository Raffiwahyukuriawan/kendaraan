                            ...
                            <?php foreach ($komentar as $komen): ?>
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        <h3 class="timeline-header no-border"><a href="#"><?= $komen->nama ?></a> Komentar dari <?= $komen->nama ?></h3>
                                    </div>
                                </div>
                                <!-- timeline time label -->
                                ...
                                <div>
                                    ...
                                    <div class="timeline-item">
                                        ...
                                        <div class="timeline-footer">
                                            ...
                                            <a class="btn btn-danger btn-sm" onclick="confirmDeleteKomen(<?= $komen->id_komen ?>)">Delete</a>
                                        </div>
                                    </div>
                                </div>
                                <!-- END timeline item -->
