                    ...
                    <div class="row mb-5">
                        ...
                        <div class="col-md-12">
                            <div class="border w-100 p-4 rounded mb-2 d-flex">
                                ...
                                <p><span>Phone:</span> <a href="tel://1234567920">+ <?= $kontak->no_telp ?></a></p>
                            </div>
                        </div>
                        <div class="col-md-12">
                            <div class="border w-100 p-4 rounded mb-2 d-flex">
                                ...
                                <p><span>Email:</span> <a href="mailto:info@yoursite.com"><?= $kontak->email ?></a></p>
                            </div>
                        </div>
                    </div>
            </div>
            <div class="col-md-8 block-9 mb-md-5">
                <form action="<?= base_url('welcome/kontak')?>" class="bg-light p-5 contact-form" method="post">
