				...
				<tbody>
					...
					foreach ($artikel as $artikel1): ?>
						<tr>
									...
									<div class="modal-dialog">
										<div class="modal-content">
											...
											<div class="modal-body">
												<form action="<?= base_url('editor/artikel/update_status') ?>" method="post">
							...
							<td><?= $artikel1->merk ?></td>
							<td>
								<a href="<?= base_url('editor/artikel/fitur/' . $artikel1->id_konten) ?>" class=" fas fa-search-plus mr-2"></a>
								<a href="<?= base_url('editor/artikel/fitur_tambah/' . $artikel1->id_konten) ?>" class="fas fa-plus"></a>
							</td>
							<td>
								<div>
									...
									<div class="modal fade" id="staticBackdrop12345<?= $artikel1->id_konten ?>" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
										...
										<div class="modal-dialog">
											<div class="modal-content">
												...
												<div class="modal-body">
													<form action="<?= base_url('editor/artikel/update') ?>" method="post" enctype="multipart/form-data">
														<input type="hidden" name="id_konten" value="<?= $artikel1->id_konten ?>">
			...
			<div class="modal fade" id="staticBackdrop123" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1"
				...
				<div class="modal-dialog">
					<div class="modal-content">
						...
						<div class="modal-body">
							<form action="<?= base_url('editor/artikel/tambah') ?>" method="post" enctype="multipart/form-data">
								<div class="card-body">
									<div class="form-group">
										<label>Judul</label>
										<input class="form-control"
