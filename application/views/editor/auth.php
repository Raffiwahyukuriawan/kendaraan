...
<body class="hold-transition login-page">
    ...
    <div class="login-box">
        ...
        <div class="card card-outline card-primary">
            <div class="card-header text-center">
                <a href="<?= base_url('admin/auth') ?>" class="h1"><b>CAR</b>BOOK</a>
            </div>
            <div class="card-body">
                <p class="login-box-msg">Sign in to start Editor session</p>
                <?php if ($this->session->flashdata('error')); ?>
                <p style="background-color: red;">
                    <?php echo $this->session->flashdata('error'); ?>
                </p>
                <form action="<?= base_url('editor/auth/login') ?>" method="post">
    ...
    <!-- AdminLTE App -->
    <script src="<?= base_url('AdminLTE-3.1.0/assets/') ?>dist/js/adminlte.min.js"></script>
</body>
