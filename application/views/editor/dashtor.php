			...
			<div class="row">
				<div class="col-lg-3 col-6">
					...
					<div class="small-box bg-info">
						...
						<a href="<?= base_url('editor/artikel') ?>" class="small-box-footer">More info <i
						...
						<div class="col-md-6">
							...
							<div class="card direct-chat direct-chat-primary">
										...
										<?php foreach ($messages as $msg): ?>
												<div class="direct-chat-msg" style="width:100%; border-collapse:collapse;">
													<div class="direct-chat-infos clearfix">
														<span class="direct-chat-timestamp float-right"><?= date('d M', strtotime($msg->tanggal)) ?> <?= $msg->waktu ?></span>
													</div>
								...
								<div class="card-footer">
									<form action="<?= base_url('editor/dashtor/komentar') ?>" method="post">
