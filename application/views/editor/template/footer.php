...
<script>
	function confirmDelete(id) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?= site_url('admin/pengelola/hapus/'); ?>" + id;
			}
		});
...
<script>
	function confirmDeleteKategori(id) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?= site_url('editor/kategori/hapus/'); ?>" + id;
			}
		});
...
<script>
	function confirmDeleteBlog(foto) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?= site_url('editor/blog/hapus/'); ?>" + foto;
			}
		});
...
<script>
	function confirmDeleteArtikel(foto) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?= site_url('editor/artikel/hapus/'); ?>" + foto;
			}
		});
...
<script>
	function confirmDeleteCarousel(foto) {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?= site_url('editor/carousel/hapus/'); ?>" + foto;
			}
		});
...
<script>
	function logout() {
		Swal.fire({
			...
			if (result.isConfirmed) {
				window.location.href = "<?= site_url('editor/auth/logout'); ?>";
			}
		});
